...
public class Main {
    public static void main(String[] args) throws SQLException {
        ...
        listEtudiants.add(new Etudiant(1, "LASSAKEUR", "Imad Eddine", "imadeddine@gmail.com", "xxxx", 1));
        listEtudiants.add(new Etudiant(2, "Belmadoui", "Sabri", "sabri@gmail.com", "xxxx", 1));
        listEtudiants.add(new Etudiant(3, "Khiat", "mohammed", "mohammed@gmail.com", "xxxx", 3));
